...
<head>
    ...
    <link rel="icon" type="image/gif/png" href="Img%20and%20Lib/monkey-business.jpg"">
</head>
<body>
<div id="wrapper">
    <img src="Img%20and%20Lib/monkey-business.jpg" id="business-img" alt="">
    <h2>Select your Monkey</h2>
    <img src="Img%20and%20Lib/monkey_swings.png" id="swing-img">
    <?php
    include_once ('Img and Lib/Monkeys.php');
